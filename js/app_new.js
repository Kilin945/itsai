...
function submitAnswer() {
    ...
    // 取得正確答案文字
    const correctText = question.answer.map((idx) => question.options[idx - 1]).join("<br>");
    ...
    questionContainer.insertAdjacentHTML(
        ...
        <div style="margin-top: 20px; padding: 15px; border-radius: 4px; background: ${
            ...
            <div style="margin-top: 10px; padding: 10px; background: white; border-radius: 4px">
                ...
                <div style='margin-top:10px; color:#007bff;'><b>正確答案：</b><br>${correctText}</div>
            </div>
    ...
    document.querySelector('button[onclick="submitAnswer()"]')?.style.setProperty("display", "none");
}
